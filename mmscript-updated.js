...
$mj(document).ready(function () {
  ...
  var calcCTC = function (offerCtc, inputlevel, inputcompany) {
    ...
    if (company == "1037") {
      ...
      if (
        inputTHP == "Technical" &&
        (level == "ol7" || level == "ol8" || level == "ol9" || level == "ol10")
      ) {
  ...
  $mj("#company").on("change", function () {
    ...
    if (
      ...
      $mj("#businessUnit").append(
        '<option value="agricultureSectorPresident">Agriculture Sector President Office</option>'
      );
      ...
      $mj("#sector").on("change", function () {
        ...
        if ($mj("#sector").val() == "farmEquipemnentSector") {
          $mj("#businessUnit").append(
            '<option value="selectbusinessUnit">Select Business Unit</option>'
          );
          $mj("#businessUnit").append(
            '<option value="SwarajDivision">Swaraj Division</option>'
          );
          $mj("#businessUnit").append(
            '<option value="FarmDivision">Farm Division</option>'
          );
          $mj("#businessUnit").append(
            '<option value="MahindraUsa">Mahindra USA (MUSA)</option>'
          );
          $mj("#businessUnit").append('<option value="MYYTCL">MYYTCL</option>');
          $mj("#businessUnit").append(
            '<option value="FesPresidentOffice">FES - President Office</option>'
          );
          $mj("#businessUnit").append(
            '<option value="precisionFarming">Precision Farming</option>'
          );
          $mj("#businessUnit").append(
            '<option value="ImplemntBusiness">Implement Business</option>'
          );
          $mj("#businessUnit").append(
            '<option value="SwarajEngines">Swaraj Engines</option>'
          );
          ...
          $mj("#businessUnit").append(
            '<option value="automotiveDivision">Automotive Division</option>'
          );
          $mj("#businessUnit").append(
            '<option value="heavyEngines">Heavy Engines</option>'
          );
          $mj("#businessUnit").append(
            '<option value="aspresidentOffice">As President Office</option>'
          );
          $mj("#businessUnit").append(
            '<option value="constructionEquipment">Construction Equipment</option>'
          );
          $mj("#businessUnit").append(
            '<option value="newBusinessSolution">New Business Solution</option>'
          );
          $mj("#businessUnit").append(
            '<option value="truckandBuses">Truck and Busess</option>'
          );
          $mj("#businessUnit").append(
            '<option value="EVtechCentre">EM - EV Tech Centre</option>'
          );
          $mj("#businessUnit").append(
            '<option value="electricMobilityLMM">Electric Mobility-LMM</option>'
          );
          ...
          $mj("#businessUnit").append(
            '<option value="businessExcellence">Business Exccellence</option>'
          );
          $mj("#businessUnit").append(
            '<option value="inovationCell">Inovation Cell</option>'
          );
          $mj("#businessUnit").append(
          ...
          $mj("#businessUnit").append(
            '<option value="mrvCommonServices">MRV Common Services</option>'
          );
          ...
          $mj("#businessUnit").append(
            '<option value="powerol">Powerol</option>'
          );
          $mj("#businessUnit").append('<option value="excise">Excise</option>');
          $mj("#businessUnit").append(
          ...
          $mj("#businessUnit").append(
            '<option value="spareBusiness">Spare Business</option>'
          );
          $mj("#businessUnit").append(
            '<option value="internationalOperation">International operation M&M</option>'
          );
        }
      });
      ...
      $mj("#businessUnit").html("");
      $mj("#businessUnit").append(
        '<option value="electricMobility">Electric Mobility</option>'
      );
