...
$mj(document).ready(function () {
  ...
  for (let abc = 0; abc < arrayOfElem.length; abc++) {
    ...
    console.log($mj('input[name="' + arrayOfElem[abc] + '"]')[0])
    console.log($mj('input[name="' + arrayOfElem[abc] + '"]')[0].val())
    console.log("After Change")
    console.log($mj('[inputname="' + arrayOfElem[abc] + '"]')[0].val().replaceAll(",",""))
    $mj('input[name="' + arrayOfElem[abc] + '"]')[0].val($mj('input[name="' + arrayOfElem[abc] + '"]')[0].val().replaceAll(",",""));
  }
