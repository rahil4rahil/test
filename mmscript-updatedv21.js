	...
	if(sal.superannuation_ann == 0)
	{
	   sal.superannuation_ann = (0).toFixed(2);
        ...
        for (let abc = 0; abc < arrayOfElem.length; abc++) {
          if (arrayOfElem[abc] != "calculateForGrade") {

            // console.log(arrayOfElem[abc])
            // console.log("Before Change")
            // console.log($mj('input[name="' + arrayOfElem[abc] + '"]'))
            // console.log($mj('input[name="' + arrayOfElem[abc] + '"]').val())
            // console.log("After Change")
            // console.log($mj('input[name="' + arrayOfElem[abc] + '"]').val().replaceAll(",",""))
            $mj('input[name="' + arrayOfElem[abc] + '"]').val(parseFloat($mj('input[name="' + arrayOfElem[abc] + '"]').val().replaceAll(",","")))
            $mj('input[name="' + arrayOfElem[abc] + '"]').change()
          }
        }
        $mj('input[name="level5PP"]').val(parseFloat($mj('input[name="level5PP"]').val().replaceAll(",","")))
        $mj('input[name="level5PP"]').change()
