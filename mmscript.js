...
var $mj = jQuery.noConflict();
	...
	$mj(document).ready(function(){
		...
		var arrayOfElem = ['calculateForGrade', 'BasicSal_mon', 'BasicSal_an', 'adhocPay_mon', 'adhocPay_an', 'pfBase_mon', 'pfBase_an', 'pf_mon', 'pf_ann', 'gratuity_mon', 'gratuity_ann', 'superannuation_mon', 'superannuation_ann', 'retirals_mon', 'retirals_ann', 'totalFixed_mon', 'totalFixed_ann', 'flexiPay_mon', 'flexiPay_an', 'bonusExgratia_mon', 'bonusExgratia_an', 'totalGuaranteed_mon', 'totalGuaranteed_an', 'performancePay_mon', 'performancePay_an', 'ctc_mon', 'ctc_an', 'grossPay_mon', 'grossPay_an'  ];
			...
			var calcCTC =  function(offerCtc, inputlevel, inputcompany){
				...
				if (company == '1037') {
			...
			else if (company == '1001' || company == '9026'|| company == '9025' || company == '1019' || company == '1020' || company == '1021') {
					...
					CTCcalculation['retirals_ann'] = ( (retirals[level] * CTCcalculation['pfBase_an'])/100 );
					CTCcalculation['retirals_mon'] = CTCcalculation['retirals_ann'] /12;

					CTCcalculation['superannuation_ann'] = Math.abs(Math.round(CTCcalculation['retirals_ann'] - CTCcalculation['pf_ann'] - CTCcalculation['gratuity_ann'] ));
					CTCcalculation['superannuation_mon'] =	CTCcalculation['superannuation_ann'] / 12;
					...
					CTCcalculation['level5PP']= Math.round( (( CTCcalculation['performancePay_an'] * 170)/100) /100)*100;
					CTCcalculation['level2PP']= Math.round(( CTCcalculation['performancePay_an'] / 65));
					CTCcalculation['level3PP']= CTCcalculation['performancePay_an'];
					CTCcalculation['level4PP']= Math.round( (( CTCcalculation['performancePay_an'] * 135)/100) /100)*100;
					CTCcalculation['calculateForDomain'] = selecteddomain;
					...
					*/
					...
					CTCcalculation['superannuation_ann'] = Math.abs(Math.abs(Math.round(superann[level] *	CTCcalculation['pfBase_an'])));
					CTCcalculation['superannuation_mon'] =	CTCcalculation['superannuation_ann'] / 12;
			...
			else if (company == '1049' || company == '1070'|| company == '1054' || company == '1055') {
					...
					*/
					...
					var esic = {
						...
						'dgm': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'gm': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'asst_manager': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'VP': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
						'sr_VP': (inputCTC_an - (retirals[level] * fixedPer[level] )) < 252000 ? (inputCTC_an - (retirals[level] * fixedPer[level] )) /1.0475 * 0.0475 : 0,
					...
					CTCcalculation['specialPay_an'] = CTCcalculation['flexiPay_an'] - (CTCcalculation['hra_ann'] + CTCcalculation['conveyance_ann'] + CTCcalculation['education_ann'] + CTCcalculation['cea_an'] + CTCcalculation['lta_ann']);
					CTCcalculation['specialPay_mon'] = CTCcalculation['specialPay_an']/12;
					CTCcalculation['esic_an'] = esic[level];
					CTCcalculation['esic_mon'] = CTCcalculation['esic_an'] /12;
					CTCcalculation['ctc_an'] = CTCcalculation['pfBase_an'] + CTCcalculation['retirals_ann'] + CTCcalculation['totalAllow_ann'] + CTCcalculation['bonusExgratia_an'] +CTCcalculation['performancePay_an'];
					CTCcalculation['ctc_mon']  = CTCcalculation['ctc_an'] /12;
					CTCcalculation['grossPay_mon'] = CTCcalculation['pfBase_mon']  +  CTCcalculation['hra_mon'] + CTCcalculation['conveyance_mon'] + CTCcalculation['bonusExgratia_mon']  + CTCcalculation['education_mon'] + CTCcalculation['cea_mon'] +CTCcalculation['specialPay_mon'] ;
					...
					CTCcalculation['individualScore'] = individual[level];
					CTCcalculation['graduityPercent'] = 4.81;
					CTCcalculation['level5PP']= (CTCcalculation['performancePay_an'] * 170)/100;
					CTCcalculation['calculateForDomain'] = selecteddomain;
	...
	else
		{
			...
			$mj('#company').on('change', function(){
				   //console.log($mj('#typeOfGlass').val());
				    $mj('#selectLevel').html('');
				    if($mj('#company').val()=='1049' || $mj('#company').val()=='1070' || $mj('#company').val()=='1054' || $mj('#company').val()=='1055'){
				    	...
				    	$mj('#businessUnit').append('<option value="mahindraSumitAgr">Mahindra Summit Agriscience</option>');


				    }

				    else if ($mj('#company').val()=='9025'|| $mj('#company').val()=='1001' || $mj('#company').val()=='9026'|| $mj('#company').val()=='1019' || $mj('#company').val()=='1020' || $mj('#company').val()=='1021') {
				    	$mj('#selectLevel').append('<option value="selectlevel">Select Level</option>');
				    	...
				    	$mj('#sector').append('<option value="otherBusiness">Other Business</option>');
				    		...
				    		$mj('#sector').on('change', function(){
				    			...
				    			if($mj('#sector').val()=='farmEquipemnentSector'){
				    				...
				    				$mj('#businessUnit').append('<option value="EVtechCentre">EM - EV Tech Centre</option>');
				    				$mj('#businessUnit').append('<option value="electricMobilityLMM">Electric Mobility-LMM</option>');
				    	...
				    	$mj('#selectLevel').append('<option value="sr_executive">Sr.Executive</option>');
				    	$mj('#selectLevel').append('<option value="manager">Manager</option>');
						$mj('#selectLevel').append('<option value="asst_manager">Asst.manager</option>');
				    	$mj('#selectLevel').append('<option value="sr_Manager">Sr.Manager</option>');
				    	...
				    	// Business Unit
				    	$mj('#businessUnit').html('');
				    	$mj('#businessUnit').append('<option value="mwtes">MWTES</option>');
				...
				$mj('#THP').on('change', function(){
				   //console.log($mj('#typeOfGlass').val());
				    ...
				    if($mj('#THP').val()=='Technical' ){
				    	...
				    	$mj('#domain').append('<option value="0">Select Domain</option>');
				    	$mj('#domain').append('<option value="1">From SSU "Commodity Heads / Sub Heads with commercial expertise.ÃƒÂ¯Ã‚Â¿Ã‚Â½ (H)</option>');
